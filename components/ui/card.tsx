...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-none border border-border bg-card text-card-foreground transition-colors hover:border-muted-foreground/30",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("text-xs font-mono text-muted-foreground uppercase tracking-wider", className)}
    {...props}
  />
));
