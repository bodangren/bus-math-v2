...
describe('cycle decisions family', () => {
  it('covers the scenario catalog and stays deterministic across seeds', () => {
    const expectedKinds = ['reversing-selection', 'closing-entry', 'correcting-entry', 'reversing-entry'] as const;
