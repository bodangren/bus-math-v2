...
- [x] Update `conductor/curriculum/` documentation if approval metadata becomes part of the canonical curriculum contract
- [x] Update `conductor/tech-debt.md` with any components lacking stable ids or harness support
- [x] Run `npm run lint`
- [x] Run targeted Vitest suites for schema, mutations, stale detection, and UI review surfaces
- [x] Run broader `npm test` because Convex review state and shared component harnesses touch multiple runtime contracts
- [x] Run build verification
- [x] Record verification results in this plan before closeout
- [x] Update `conductor/tracks.md` with closeout details
- [x] Archive the track when complete
