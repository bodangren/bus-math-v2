...
- `npm test` — all tests pass (2046 tests)
- `npm run build` — clean
- Commit: `feat(activities): add graphing explorer with business math exploration configs (port from ra-integrated-math-3)`

## Track Complete

**Closeout: completed on 2026-04-16. All 5 phases complete.**

- Phase 1: Library port (canvas-utils, linear-parser, quadratic-parser) — 56 tests
- Phase 2: Component port (GraphingCanvas, InteractiveTableOfValues, HintPanel, InterceptIdentification, GraphingExplorer with compare_lines/multi_curve variants) — 19 tests
- Phase 3: Business math exploration configs (CVP, Supply/Demand, Depreciation) — 11 tests
- Phase 4: Registry integration (schema, registry, type export)
- Phase 5: Verification gates pass (lint 0 errors, test 2046/2046, build clean)
