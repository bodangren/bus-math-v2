...
Verified slice: Unit 1 lessons 2, 4, and 7 now split guided and independent practice onto distinct activity ids, and later authored units now surface explicit teacher-model / worked-example callouts in instruction while the published-manifest regression suite guards that contract.
