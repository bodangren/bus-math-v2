...
## 5. Teaching-Mode Overlay
The shared practice shells now support runtime teaching chrome through `TeachingModePanel`, so instructor-facing narration stays outside the submission envelope while the underlying family component remains the source of truth.
