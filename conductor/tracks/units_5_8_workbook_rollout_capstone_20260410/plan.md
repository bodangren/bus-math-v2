...
- [ ] Build `/capstone/rubrics` route serving pitch rubric, model tour checklist, and grading criteria
- [ ] Verify both capstone routes work for authenticated students and teachers
- [ ] Update wave2-authored and capstone-authored curriculum files with how-to, rubric, and asset content
...
- [ ] Update Conductor docs to reflect complete curriculum workbook system
