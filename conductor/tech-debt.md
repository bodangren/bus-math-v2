...
| 2026-04-06 | code_review_tracks6-8 | Most simulation components use useState-only double-submit guard; should adopt useRef pattern | Medium | Open | useState guard vulnerable to rapid double-clicks in React 18 batching. |
