...
|------|-------|------|----------|--------|-------|
| 2026-03-13 | curriculum_rollout_wave1 | Units 5-8 and capstone still rely on generated publish scaffolds even though Units 1-4 are now authored and canonical | Critical | Open | Continue the planned Wave 2 and capstone tracks, but keep Wave 2 blocked on the accepted Unit 1 redesign exemplar so the remaining 45 lessons do not drift from the contract again. |
