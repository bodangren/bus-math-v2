...
- (2026-03-24, practice_visual_teaching_upgrade_20260323) Scenario and evidence context belongs inside shared component props, not preview-page JSX, or the dev page becomes the de facto API.
- (2026-03-24, practice_visual_teaching_upgrade_20260323) Mode-driven hints are easier to verify than a user-facing toggle, especially when teacher review needs a stable DOM order.
...
- (2026-03-31, curriculum_rollout_20260331) Activity components and practice families are separate layers—curriculum wiring means ensuring activities use consistent family keys in artifacts, not necessarily matching practice registry keys exactly; self-contained activities with static scenarios can still submit valid practice.v1 envelopes.
