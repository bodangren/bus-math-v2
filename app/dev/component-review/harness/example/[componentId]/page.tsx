      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-6">
        <header className="space-y-2 rounded-2xl border bg-white/90 p-6 shadow-sm">
          ...
          <p className="text-sm text-slate-600">
            Review harness for example component <code className="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-xs">{componentId}</code>.
        ...
        <section className="rounded-2xl border bg-amber-50/80 p-6 shadow-sm">
          ...
          <ul className="mt-3 space-y-2 text-sm text-amber-800">
            <li>Renders all three modes (worked example, guided practice, independent practice)</li>
            <li>Allows manual mode switching</li>
            <li>Exercises multiple practice variants</li>
            <li>Prevents approval until required checks are completed</li>
          </ul>
        </section>
      </div>
    </main>
