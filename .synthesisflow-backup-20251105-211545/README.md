...
```bash
bash .synthesisflow-backup-20251105-211545/rollback.sh
```
...
2. **Restore original docs/**:
   ```bash
   cp -r .synthesisflow-backup-20251105-211545/docs .
   ```
...
- Created: 2025-11-05T21:15:45+08:00
- Migration manifest: migration-manifest.json
- Original location: /home/daniel-bo/Desktop/bus-math-v2
